        ...
        if (percent) {
            if (Number.isNaN(+percent)) {
                ...
                if (percent > 100) {
                    ...
                    invalidpercent.setDescription('<:CatieError:839151745665204234> You need type volume which is less than 100')
            ...
            noargs.setDescription('<:CatieError:839151745665204234> You need type volume.')
